...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImageContainer.style.width="35%"; -----------------------------------------------------different
  ...
  pizzaDescriptionContainer.style.width="65%"; -----------------------------------------------different
...
var resizePizzas = function(size) {
  ...
  // Iterates through pizza elements on the page and changes their widths ------------------------------------------------restructured code
  ...
  console.log("Time to resize pizzas: " + timeToResize[timeToResize.length-1].duration + "ms");---------------------------------------------different
};
...
function logAverageFrame(times) {   // times is the array of User Timing measurements from updatePositions()
  ...
  console.log("Average scripting time to generate last 10 frames: " + sum / 10 + "ms");---------------------------------------------different
}
...
function updatePositions() {
  ...
  var items = document.querySelectorAll('.mover'); --------------------------------------different
